<h2><a href="https://www.geeksforgeeks.org/problems/palindrome-pairs/1?page=7&company=Amazon&sprint=a663236c31453b969852f9ea22507634&sortBy=submissions">Palindrome Pairs</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of strings arr[] of size N, find if there exists 2 strings arr[i] and arr[j] such that arr[i]+arr[j] is a palindrome i.e the concatenation of string arr[i] and arr[j] results into a palindrome.</span></p>
