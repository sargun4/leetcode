<h2><a href="https://practice.geeksforgeeks.org/problems/path-in-matrix3805/1?page=1&category=Matrix&sprint=a663236c31453b969852f9ea22507634&sortBy=submissions">Maximum path sum in matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a NxN&nbsp;matrix&nbsp;of positive integers.&nbsp;There are only three possible moves from a cell <strong>Matrix[r][c]</strong>.</span></p>
