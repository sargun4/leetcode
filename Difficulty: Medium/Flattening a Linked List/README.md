<h2><a href="https://www.geeksforgeeks.org/problems/flattening-a-linked-list--170645/1?page=4&company=Paytm&sortBy=submissions">Flattening a Linked List</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Linked List of size N, where every node represents a sub-linked-list and contains two pointers:<br>
